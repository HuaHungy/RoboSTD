...
temp_urdf_path = None
try:
    if urdf_file_path.suffix.lower() == ".urdf":
        ...
        temp_urdf_path = urdf_file_path.parent / (urdf_file_path.stem + "_patched_temp.urdf")
        tree.write(temp_urdf_path)
        load_path = temp_urdf_path
    else:
        load_path = urdf_file_path
    ...
    if temp_urdf_path and temp_urdf_path.exists():
        temp_urdf_path.unlink()
